...
-- Exclude rows already invalid due to datatype issues
AND o._row_id NOT IN (
    SELECT row_id
    FROM silver.datatype_validation_errors_log
    WHERE table_name = 'orders'
